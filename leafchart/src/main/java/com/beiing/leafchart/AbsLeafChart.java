...
//        measure(widthMeasureSpec,heightMeasureSpec);
        ...
        {
            Log.i("绘制 ：","绘制1");
            width = widthSpecSize*2;
            Log.i("绘制 ：","绘制1宽度 ：" + width);
        } else
        {
            Log.i("绘制 ：","绘制2");
            width = (int) mWidth;
            Log.i("绘制 ：","绘制2宽度 ：" + width);
        }
        ...
        if (heightSpecMode == MeasureSpec.EXACTLY)
        {
            ...
            Log.i("绘制 ：","绘制3高度 ：" + height);
        } else
        {
            Log.i("绘制 ：","绘制5");
            height = (int) mHeight;
            Log.i("绘制 ：","绘制5高度 ：" + height);
        }
...
//        }
    ...
    protected void initViewSize() {
        mWidth = getMeasuredWidth();//获取view全部宽度
        Log.i("绘制 ：","绘制4 :" + mWidth);
