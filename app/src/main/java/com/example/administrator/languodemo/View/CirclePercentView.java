package com.example.administrator.languodemo.View;
...
public class CirclePercentView extends View {
    ...
    public CirclePercentView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRadius = a.getDimensionPixelSize(R.styleable.CirclePercentView_radius,dpToPx(100,context));
    }
    ...
    public int spToPx(int sp,Context context) {
